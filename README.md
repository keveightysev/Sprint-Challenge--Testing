...
describe() groups tests together, while it() is ths method in which you actually write the test code.

1. What is the point of `Test Driven Development`? What do you think about this approach?

I would say that the point is to have a focus on being cognizant of edge cases, writing a test for them, and making sure your test passes it.
